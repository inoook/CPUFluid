 ...
 */
public class ParticleSystem : Processing {
	...
	public int colorBufferNum = 300;//tmpInputColorBUffer
    ...
    public void ParticleSystemInit(MSAFluidSolver2D fluidSolver) {
    ...
    public void updateAndDraw(){
		...
		//Debug.Log("update_num: "+update_num + " update_stay_num: "+update_stay_num);
